...
const megamenuData = [
    ...
    {
        title: "Outsourced Roles",
        href: "/services/outsourced-roles",
        items: [
            { name: "Cybersecurity Architect", href: "/services/outsourced-roles/cybersecurity-architect" },
            { name: "Cybersecurity Manager (CISO)", href: "/services/outsourced-roles/cybersecurity-manager" },
            { name: "Internal Auditor", href: "/services/outsourced-roles/internal-auditor" },
            { name: "Risk Management Specialist", href: "/services/outsourced-roles/risk-management-specialist" },
            { name: "Data Privacy Officer (DPO)", href: "/services/outsourced-roles/data-privacy-officer" },
            { name: "ISMS Manager", href: "/services/outsourced-roles/isms-manager" },
            { name: "Compliance Officer", href: "/services/outsourced-roles/compliance-officer" },
        ],
    },
];
...
export default function Navbar({ onOpenCalculator }: NavbarProps) {
    ...
    const navLinks = [
        ...
        { href: "/market-industries", label: "Industries" },
    ...
    return (
        <>
            ...
            >
                <div className="w-full bg-background/50 backdrop-blur-md border-b border-foreground/10 px-6 py-4 md:px-12 shadow-lg transition-all duration-300">
